...
class EarthquakeServiceIntegrationTest {
    ...
    @Test
    void fetchAndStore_filtersLowMagnitudeAndClearsOldData() {
        // Pre-existing record that should be wiped
        ...
        // Mock USGS returning 3 earthquakes: mag 1.5 (below threshold), 3.0, 5.5
        ...
        assertThat(all).extracting(Earthquake::getUsgsId)
                .containsExactlyInAnyOrder("eq-mid", "eq-high");
        // Old record should be gone
        assertThat(all).extracting(Earthquake::getUsgsId)
                .doesNotContain("old-record");
    }
